(function () {
  ...
  function createPagination() {
    ...
    for (let i = startPage; i <= endPage; i++) buttonsDiv.appendChild(createPageButton(i));
  ...
  function createPageButton(pageNum) {
    ...
    btn.addEventListener('click', () => { currentPage = pageNum; renderPage(); });
    return btn;
  }
  ...
  function renderPage() {
    ...
    pageItems.forEach(item => { if (!item.hidden) item.style.display = ''; });
